...
if {[file isfile keccak_top.autotvin.dat]} {
	file delete -force keccak_top.autotvin.dat
}

if {[file isfile keccak_top.autotvout.dat]} {
	file delete -force keccak_top.autotvout.dat
}
