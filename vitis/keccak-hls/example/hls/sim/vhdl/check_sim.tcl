...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.keccak_top.autotvin_input_stream_V_data_V.dat"
         "c.keccak_top.autotvin_input_stream_V_keep_V.dat"
         "c.keccak_top.autotvin_input_stream_V_strb_V.dat"
         "c.keccak_top.autotvin_input_stream_V_last_V.dat"
         "c.keccak_top.autotvin_rate_bytes.dat"
         "c.keccak_top.autotvin_delimiter.dat"
         "c.keccak_top.autotvin_output_len.dat"
         "c.keccak_top.autotvin_input_len.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.keccak_top.autotvout_output_stream_V_data_V.dat"
         "rtl.keccak_top.autotvout_output_stream_V_keep_V.dat"
         "rtl.keccak_top.autotvout_output_stream_V_strb_V.dat"
         "rtl.keccak_top.autotvout_output_stream_V_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
