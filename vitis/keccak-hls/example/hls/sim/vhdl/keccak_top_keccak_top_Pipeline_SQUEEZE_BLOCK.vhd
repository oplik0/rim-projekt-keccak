...
attribute shreg_extract : string;
    ...
    signal icmp_ln348_fu_386_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln353_fu_497_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln353_reg_714 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal trunc_ln357_fu_523_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal trunc_ln357_reg_724 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal add_ln348_fu_391_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal ap_block_pp0_stage0_01001_grp1 : BOOLEAN;
    signal select_ln357_fu_548_p3 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal shl_ln357_fu_517_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln357_fu_543_p2 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                elsif (((icmp_ln348_fu_386_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
    ...
    add_ln348_fu_391_p2 <= std_logic_vector(unsigned(i_fu_180) + unsigned(ap_const_lv6_1));
    add_ln357_fu_543_p2 <= std_logic_vector(unsigned(trunc_ln357_reg_724) + unsigned(ap_const_lv8_FF));
    ...
    ap_condition_exit_pp0_iter1_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_subdone, icmp_ln348_fu_386_p2)
    begin
        if (((icmp_ln348_fu_386_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    bytes_out_fu_503_p3 <= 
        ap_const_lv32_8 when (icmp_ln353_fu_497_p2(0) = '1') else 
        output_remaining_1_fu_176;
    icmp_ln348_fu_386_p2 <= "1" when (i_fu_180 = trunc_ln6) else "0";
    icmp_ln353_fu_497_p2 <= "1" when (signed(tmp_fu_487_p4) > signed(ap_const_lv29_0)) else "0";
    output_remaining_1_out <= output_remaining_1_fu_176;

    output_remaining_1_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln348_fu_386_p2, ap_loop_exit_ready, ap_block_pp0_stage0_11001)
    begin
        if (((ap_loop_exit_ready = ap_const_logic_1) and (icmp_ln348_fu_386_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    select_ln357_fu_548_p3 <= 
        ap_const_lv8_FF when (icmp_ln353_reg_714(0) = '1') else 
        add_ln357_fu_543_p2;
    shl_ln357_fu_517_p2 <= std_logic_vector(shift_left(unsigned(ap_const_lv32_1),to_integer(unsigned('0' & bytes_out_fu_503_p3(31-1 downto 0)))));
    tmp_fu_487_p4 <= output_remaining_1_fu_176(31 downto 3);
    trunc_ln357_fu_523_p1 <= shl_ln357_fu_517_p2(8 - 1 downto 0);
end behav;
