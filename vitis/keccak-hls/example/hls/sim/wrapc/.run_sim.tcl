...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "keccak_top.autotvin.dat"
	set constFileTvOut       "keccak_top.autotvout.dat"
	set constFileHdlTvIn     "keccak_top.autohdltvin.dat"
	set constFileHdlTvOut    "keccak_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
