set SynModuleInfo {
  {SRCNAME keccak_top_Pipeline_ABSORB_BLOCK MODELNAME keccak_top_Pipeline_ABSORB_BLOCK RTLNAME keccak_top_keccak_top_Pipeline_ABSORB_BLOCK
    SUBMODULES {
  ...
  {SRCNAME keccak_top MODELNAME keccak_top RTLNAME keccak_top IS_TOP 1
    SUBMODULES {
      {MODELNAME keccak_top_urem_32ns_8ns_32_36_seq_1 RTLNAME keccak_top_urem_32ns_8ns_32_36_seq_1 BINDTYPE op TYPE urem IMPL auto_seq LATENCY 35 ALLOW_PRAGMA 1}
