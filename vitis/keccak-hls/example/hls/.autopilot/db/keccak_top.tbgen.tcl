...
set C_modelArgList {
	...
	{ input_len int 32 regular {axi_slave 0}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "input_stream_V_data_V", "interface" : "axis", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "input_len", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":40}, "offset_end" : {"in":47}} ]}
...
set ArgLastReadFirstWriteLatency {
	keccak_top {
		...
		input_len {Type I LastRead 0 FirstWrite -1}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "78", "Max" : "64578"}
	, {"Name" : "Interval", "Min" : "79", "Max" : "64579"}
]}
