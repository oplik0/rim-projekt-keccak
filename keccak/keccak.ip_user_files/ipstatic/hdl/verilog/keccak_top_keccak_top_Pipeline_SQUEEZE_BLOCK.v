...
input  [5:0] trunc_ln4;
input  [63:0] state_5217;
input  [63:0] state_1_5;
input  [63:0] state_2_5;
input  [63:0] state_3_5;
input  [63:0] state_4_5;
input  [63:0] state_5_5;
input  [63:0] state_6_5;
input  [63:0] state_7_5;
input  [63:0] state_8_5;
input  [63:0] state_9_5;
input  [63:0] state_10_5;
input  [63:0] state_11_5;
input  [63:0] state_12_5;
input  [63:0] state_13_5;
input  [63:0] state_14_5;
input  [63:0] state_15_5;
input  [63:0] state_16_5;
input  [63:0] state_17_5;
input  [63:0] state_18_5;
input  [63:0] state_19_5;
input  [63:0] state_20_5;
input  [63:0] state_21_5;
input  [63:0] state_22_5;
input  [63:0] state_23_5;
input  [63:0] state_24_5;
...
wire   [0:0] icmp_ln315_fu_497_p2;
reg   [0:0] icmp_ln315_reg_714;
wire   [31:0] output_remaining_2_fu_511_p2;
reg   [31:0] output_remaining_2_reg_719;
wire   [7:0] trunc_ln319_fu_523_p1;
reg   [7:0] trunc_ln319_reg_724;
reg   [31:0] output_remaining_1_fu_176;
wire   [31:0] output_remaining_cast_fu_369_p1;
wire    ap_loop_init;
wire    ap_block_pp0_stage0;
reg   [5:0] i_fu_180;
wire   [5:0] add_ln310_fu_391_p2;
reg    ap_block_pp0_stage0_01001_grp1;
wire   [7:0] select_ln319_fu_548_p3;
...
wire   [31:0] shl_ln319_fu_517_p2;
wire   [7:0] add_ln319_fu_543_p2;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            i_fu_180 <= 6'd0;
        end else if (((icmp_ln310_fu_386_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln310_fu_386_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((ap_loop_exit_ready == 1'b1) & (icmp_ln310_fu_386_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln310_fu_391_p2 = (i_fu_180 + 6'd1);

assign add_ln319_fu_543_p2 = ($signed(trunc_ln319_reg_724) + $signed(8'd255));
...
assign bytes_out_fu_503_p3 = ((icmp_ln315_fu_497_p2[0:0] == 1'b1) ? 32'd8 : output_remaining_1_fu_176);

assign icmp_ln310_fu_386_p2 = ((i_fu_180 == trunc_ln4) ? 1'b1 : 1'b0);

assign icmp_ln315_fu_497_p2 = (($signed(tmp_fu_487_p4) > $signed(29'd0)) ? 1'b1 : 1'b0);
...
assign output_stream_TKEEP = select_ln319_fu_548_p3;

assign output_stream_TLAST = (($signed(output_remaining_2_reg_719) < $signed(32'd1)) ? 1'b1 : 1'b0);

assign output_stream_TSTRB = select_ln319_fu_548_p3;

assign p_0_fu_404_p51 = 'bx;

assign p_0_fu_404_p52 = i_fu_180[4:0];

assign select_ln319_fu_548_p3 = ((icmp_ln315_reg_714[0:0] == 1'b1) ? 8'd255 : add_ln319_fu_543_p2);

assign shl_ln319_fu_517_p2 = 32'd1 << bytes_out_fu_503_p3;

assign tmp_fu_487_p4 = {{output_remaining_1_fu_176[31:3]}};

assign trunc_ln319_fu_523_p1 = shl_ln319_fu_517_p2[7:0];
