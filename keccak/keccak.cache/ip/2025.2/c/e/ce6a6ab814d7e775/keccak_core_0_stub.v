...
// Date        : Tue Dec 23 01:08:22 2025
// Host        : DESKTOP-DI4989O running 64-bit major release  (build 9200)
// Command     : write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ keccak_core_0_stub.v
...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(ap_clk, ap_rst_n, input_stream_TDATA, 
  input_stream_TVALID, input_stream_TREADY, input_stream_TKEEP, input_stream_TSTRB, 
  input_stream_TLAST, output_stream_TDATA, output_stream_TVALID, output_stream_TREADY, 
  output_stream_TKEEP, output_stream_TSTRB, output_stream_TLAST, s_axi_control_AWVALID, 
...
/* synthesis syn_black_box black_box_pad_pin="ap_rst_n,input_stream_TDATA[63:0],input_stream_TVALID,input_stream_TREADY,input_stream_TKEEP[7:0],input_stream_TSTRB[7:0],input_stream_TLAST[0:0],output_stream_TDATA[63:0],output_stream_TVALID,output_stream_TREADY,output_stream_TKEEP[7:0],output_stream_TSTRB[7:0],output_stream_TLAST[0:0],s_axi_control_AWVALID,s_axi_control_AWREADY,s_axi_control_AWADDR[5:0],s_axi_control_WVALID,s_axi_control_WREADY,s_axi_control_WDATA[31:0],s_axi_control_WSTRB[3:0],s_axi_control_ARVALID,s_axi_control_ARREADY,s_axi_control_ARADDR[5:0],s_axi_control_RVALID,s_axi_control_RREADY,s_axi_control_RDATA[31:0],s_axi_control_RRESP[1:0],s_axi_control_BVALID,s_axi_control_BREADY,s_axi_control_BRESP[1:0],interrupt" */
/* synthesis syn_force_seq_prim="ap_clk" */;
  (* x_interface_info = "xilinx.com:signal:clock:1.0 ap_clk CLK" *) (* x_interface_mode = "slave ap_clk" *) (* x_interface_parameter = "XIL_INTERFACENAME ap_clk, ASSOCIATED_RESET ap_rst_n, FREQ_TOLERANCE_HZ -1, FREQ_HZ 100000000, PHASE 0.0, INSERT_VIP 0" *) input ap_clk /* synthesis syn_isclock = 1 */;
